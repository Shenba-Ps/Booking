			...
			<div>
				...
				<div class="Level form-group">
					<div class="form-group" onClick="OpenCustomerDetail()"
						style="font-style: underline; color: navyblue; font-weight: 600; font-size: 18px; font-style: underline;">Edit
						Customer Detail</div>
					<div id="divTab"></div>
					<br />
					<div class="Title form-group"
						style="text-align: center; float: left;">LEVEL 1</div>
					<div class="row">
						<div class="col-md-12" style="font-weight: 600; font-size: 18px;">
							* Slot Price Level 1: <span id="spnPriceL1">$ 0.00</span>
						</div>
						<div class="col-md-12" style="font-weight: 600; font-size: 18px;">
							* Slot Price Level 2: <span id="spnPriceL2">$ 0.00</span>
						</div>
						<div class="col-md-12" style="font-weight: 600; font-size: 18px;">
							* Add On (Additional socket): <span id="spnAdonPrice">$
								20.00</span>
						</div>
					</div>
					<div class="row">
				...
				<div class="row form-group" style="padding: 50px;">
					<div class="col-md-12 form-group">
						<input id="chkAdditionalPlugPoint" type="checkbox"> Please
						select if require additional power point (+ $20.00))</input>
					</div>
					<div class="col-md-12 form-group">
							...
							<div class="row form-group Others" style="display: none;">
								...
								<div class="col-xs-6">
									<input class="form-control InputClear" type="text"
										...
										<%if (request.getAttribute("atrOthers") == null) {
				request.setAttribute("atrOthers", "");
			}%>
							...
							<div class="row form-group">
								...
								<div class="col-xs-6">
									<input class="form-control LandlineNumber InputClear"
										...
										value="" placeholder="Should start with 6">
							...
							<div class="row form-group">
								...
								<div class="col-xs-6">
									<input class="form-control PhoneNumber InputClear" type="text"
										...
										placeholder="Should start with 8 or 9">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"
								onclick="onclickHome()">Home</button>
							<button type="button" class="btn btn-primary"
